...
const myProductUploader = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (uploaded) {
            ...
            let Product = new snacksCat_model_1.snacksCatModel(Object.assign(Object.assign({}, req.body), { productImage: myImage }));
            let newProduct = yield snacksCat_model_1.snacksCatModel.create(Product);
            if (newProduct) {
