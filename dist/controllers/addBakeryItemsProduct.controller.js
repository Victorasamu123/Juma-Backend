...
exports.myBakeryProductUploader = void 0;
...
const myBakeryProductUploader = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (uploaded) {
            ...
            let Product = new bakeryItems_model_1.bakeryItemsCatModel(Object.assign(Object.assign({}, req.body), { productImage: myImage }));
            let newProduct = yield bakeryItems_model_1.bakeryItemsCatModel.create(Product);
            if (newProduct) {
...
exports.myBakeryProductUploader = myBakeryProductUploader;
